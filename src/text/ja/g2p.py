# Reference: https://github.com/oohara1202/vits/blob/main/abelab_utils/g2p.py
import re
...
class G2P:
    @classmethod
    def from_grapheme(cls, text: str, drop_unvoiced_vowels: bool = True) -> str:
    ...
    def _get_phonetic_prosodic_symbol(cls, labels: List[str], drop_unvoiced_vowels: bool = True) -> List[str]:
        ...
        for n in range(N):
            ...
            # current phoneme
            p3 = re.search(r"\-(.*?)\+", lab_curr).group(1) # pyright: ignore[reportOptionalMemberAccess]
